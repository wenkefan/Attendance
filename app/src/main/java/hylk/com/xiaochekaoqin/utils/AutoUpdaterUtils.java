...
public class AutoUpdaterUtils {
    ...
    private final String URL = "http://manage.youery.com/App/ReleaseList_XIAOCHE_KAOQIN.xml"; // xml请求地址
    private final String URLS = "http://manage.youery.com/App/";  // 下载地址
    /**
     * 单例对象实例
     */
        ...
        while (event != XmlPullParser.END_DOCUMENT) {
            ...
            case XmlPullParser.START_TAG:
                if ("AutoUpdater".equals(pullParser.getName())) {
                    ...
                    auto.setCurrentVersionFileUrl(URLS  + pullParser.getAttributeValue(2) );

                    auto.setCurrentVersionFileName(pullParser.getAttributeValue(2));
                }
